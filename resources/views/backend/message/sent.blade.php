                        ...
                        <div class="box-body no-padding">
                            <div class="table-responsive mailbox-messages">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                    @if(count($sentItem)>0)
                                        @foreach($sentItem as $sendData)
                                            <tr>
                                                <td class="mailbox-name"><a href="{{route('message.chat',$sendData->id)}}">{{$sendData->User->name}}</a></td>
                                                <td class="mailbox-subject"><b>{{$sendData->user->name}}</b> - {{$sendData->subject}}
                                                </td>
                                                <td class="mailbox-attachment"></td>
{{--                                                <td class="mailbox-date">5 mins ago</td>--}}
                                            </tr>
