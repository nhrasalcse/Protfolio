                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            @if(count($employee)>0)
                                @foreach($employee as $userData)
                            <tr>
                                <td><img src="{{!empty($userData->image) ? asset('image/employee/'.$userData->image) : asset('image/user-pic/user.jpg')}}" alt="" height="50px" width="50px"></td>
                                ...
                                <td>{{!empty($userData->designation) ? $userData->designation :''}}</td>
                                ...
                                <div class="modal-dialog" role="document" style="width: 100%; max-width: 1000px;">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST"  action="{{ route('employee.update',$userData->id) }}" enctype="multipart/form-data">
                                                @csrf
                                        ...
                                        <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" value="{{!empty($userData->designation) ? $userData->designation :''}}" placeholder="Enter Designation" >
                                                    @error('designation')
                                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        ...
                                        <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group has-feedback">
                                                    <img src="{{!empty($userData->image) ? asset('image/employee/'.$userData->image) : asset('image/user-pic/user.jpg')}}" alt="" height="50px" width="50px">
                                                </div>
